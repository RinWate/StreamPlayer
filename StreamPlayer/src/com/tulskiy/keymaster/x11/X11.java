...
public interface X11 extends Library {
	...
	public int XGrabKey(Pointer display, int code, int modifiers, NativeLong root, int ownerEvents, int pointerMode,
			int keyBoardMode);
	...
	public static class XKeyEvent extends Structure {
		...
		protected List<String> getFieldOrder() {
			return Arrays.asList("type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x",
					"y", "x_root", "y_root", "state", "keycode", "same_screen");
		}
	}
