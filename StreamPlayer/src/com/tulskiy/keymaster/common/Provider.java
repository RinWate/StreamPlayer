...
/**
 * Main interface to global hotkey providers <br>
...
public abstract class Provider {
	...
	/**
	 * Stop the provider. Stops main thread and frees any resources. <br>
	...
	/**
	 * Register a media hotkey. Currently supported media keys are: <br>
	 * <ul>
	 * <li>Play/Pause</li>
	 * <li>Stop</li>
	 * <li>Next track</li>
